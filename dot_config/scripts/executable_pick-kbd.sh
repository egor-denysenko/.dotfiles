...
#
# SCOPE: this edits `kbd`, the machine-wide DEFAULT (the `type:keyboard`
# block). If `kbd_usb` is set in the same config, that one external keyboard
# keeps its own layout and is unaffected by this script.
set -euo pipefail
